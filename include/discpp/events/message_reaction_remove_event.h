...
namespace discpp {
	...
	public:
		inline MessageReactionRemoveEvent(Shard& shard, discpp::Message message, discpp::Emoji emoji, discpp::User user) : Event(shard), message(message), emoji(emoji), user(user) {}
