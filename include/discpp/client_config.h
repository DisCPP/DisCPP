...
namespace discpp {
	...
	public:
		...
		ClientConfig(std::vector<std::string> prefixes, int logger_flags = logger_flags::ERROR_SEVERITY | logger_flags::WARNING_SEVERITY, int messageCacheSize = 5000, std::string logger_path = "")
